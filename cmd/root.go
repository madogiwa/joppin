...
func init() {
	...
	rootCmd.PersistentFlags().StringVar(&cfgFile, "config", "", "config file (default is $HOME/.joppin.yaml)")
...
func initConfig() {
	...
	if cfgFile != "" {
		...
		// Search config in home directory with name ".joppin" (without extension).
